...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 09, 2025 at 02:16 AM
...
-- Table structure for table `tblemployee_archive`

CREATE TABLE `tblemployee_archive` (
...
--
-- Indexes for table `tblemployee_archive`
ALTER TABLE `tblemployee_archive`
  ADD PRIMARY KEY (`archive_id`),
  ADD KEY `idx_earch_employee` (`employee_id`),
  ADD KEY `idx_earch_archived_at` (`archived_at`),
  ADD KEY `fk_earch_archived_by` (`archived_by`);
...
--
-- AUTO_INCREMENT for table `tblemployee_archive`
ALTER TABLE `tblemployee_archive`
...
--
ALTER TABLE `tblpayroll_batch_employees`
  MODIFY `batch_emp_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `tblemployee_archive`
ALTER TABLE `tblemployee_archive`
  ADD CONSTRAINT `fk_earch_archived_by` FOREIGN KEY (`archived_by`) REFERENCES `tblusers` (`user_id`) ON DELETE SET NULL,
  ADD CONSTRAINT `fk_earch_employee` FOREIGN KEY (`employee_id`) REFERENCES `tblemployees` (`employee_id`) ON DELETE CASCADE;
